...
var topics = ['memes', 'dank memes', 'jet fuel can\'t melt steel beams', 'pepe', 'dat boi', 'dickbutt', 'zodiac killer', 'trump', 'pokemon go', 'ayy lmao', 'shitposting', 'deal with it', 'spongebob', 'caveman spongebob', 'surprised patrick', 'squidward', 'feels', 'party hard', 'drunk', 'banana', 'lolwut', 'doge', 'shibe', 'swiggity swooty', 'dat booty', 'swag', 'haters gonna hate', 'boss', 'queen bey', 'troll', 'reaction images', 'come at me bro', 'fail', 'rickroll', 'nyan cat', 'rustle jimmies'];
    ...
    $('#addMeme').on('click', function() {
        ...
        //taking the text from the input and adding it as a variable. Then push it to the topics array
        var newTerm = $("#meme-input").val().trim();
        topics.push(newTerm);

        //run the createButtons function which will create a new set of buttons including the new one submitted from the form box
        createButtons();
